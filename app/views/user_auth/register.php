...
<body class="min-h-screen font-sans bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center px-4 py-12">
  ...
  <div class="bg-white border border-amber-200 shadow-lg rounded-2xl p-8 w-full max-w-md">
    ...
    <div class="text-center mb-6">
      ...
      <p class="text-gray-600 text-sm mt-1">Create a new account</p>
    </div>
    ...
    <form method="post" action="<?= site_url('register') ?>" class="space-y-6">
      <div>
      ...
      <div>
        ...
        <div class="relative">
          <i class="fas fa-envelope absolute left-3 top-1/2 transform -translate-y-1/2 text-amber-400"></i>
      ...
      <div>
        ...
        <div class="relative">
          <i class="fas fa-users absolute left-3 top-1/2 transform -translate-y-1/2 text-amber-400"></i>
    ...
    <p class="text-center mt-6 text-sm text-gray-600">Already have an account? 
      <a href="<?= site_url('login') ?>" class="text-amber-600 hover:text-amber-800 font-semibold transition-colors">Login here</a>
    </p>
